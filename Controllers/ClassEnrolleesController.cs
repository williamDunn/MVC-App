    ...
    public class ClassEnrolleesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var classEnrollee = await _context.ClassEnrollees
                ...
                .Include(c => c.Member)
                .SingleOrDefaultAsync(m => m.enrolledRegisrationId == id);
            ...
            ViewBag.listofmembers = memlist;
             ...
             foreach (var m in _context.ClassSessions.Include(f => f.FitnessClass))
               sessionlist.Add(new SelectListItem
                {
                    Text = m.FitnessClass.fitnessclassTitle + "  $" + m.FitnessClass.fitnessclassFee,
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var classEnrollee = await _context.ClassEnrollees.SingleOrDefaultAsync(m => m.enrolledRegisrationId == id);
            if (classEnrollee == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var classEnrollee = await _context.ClassEnrollees
                .Include(c => c.ClassSession)
                .Include(f => f.ClassSession.FitnessClass) 
                .Include(c => c.Member)
                .SingleOrDefaultAsync(m => m.enrolledRegisrationId == id);
            if (classEnrollee == null)
            {
