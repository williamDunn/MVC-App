    ...
    public class ClassSessionsController : Controller
    {
      ...
      /*  public async Task<IActionResult> Index()
        ...
        */
        ...
        // MODIFIED FOR HOMEWORK #5
        public async Task<IActionResult> Index()
        {
            var scheduledClasses = _context.ClassSessions.Include(c => c.FitnessClass).Include(c => c.Location);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var classSession = await _context.ClassSessions
                ...
                .SingleOrDefaultAsync(m => m.classSessionId == id);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var classSession = await _context.ClassSessions.SingleOrDefaultAsync(m => m.classSessionId == id);
            if (classSession == null)
            {
                return NotFound();
            }
